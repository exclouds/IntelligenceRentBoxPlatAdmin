  ...
  <div class="imClient-wrapper">
    <div class="imClient-inner">
      <header class="imClient-header">
        <div class="name-wrapper position-v-mid">
          ...
          <span v-else-if="chatInfoEn.chatState == 'agent'"
            >您正在与客服{{ serverChatEn.serverChatName }}对话</span
          >
        </div>
      ...
      <main class="imClient-main">
        ...
        <div class="item imClientInfo-wrapper">
          <article class="imClientInfo-notice-wrapper">
            <header class="imClientInfo-item-header">公告</header>
            <main class="imClientInfo-notice-main">
              <p class="link">
                github：
                <a href="https://github.com/polk6/vue-im" target="_blank"
                  >github.com/polk6/vue-im</a
                >
              </p>
              <p class="link">
                blog：
                <a
                  href="https://www.cnblogs.com/polk6/p/vue-im.html"
                  target="_blank"
          ...
          <article class="imClientInfo-faq-wrapper">
            <header class="imClientInfo-item-header">常见问题</header>
    ...
    >
      ...
      <div class="footer">
        ...
        <el-button type="primary" @click="logoutDialog_submit"
          >结束会话</el-button
        >
      </div>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    regSocket: function (serverChatId) {
      this.$data.socket = require("socket.io-client")("http://localhost:9518"); //3001
