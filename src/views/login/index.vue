<template>
  <div class="login">
    ...
    <div class="w">
      ...
      <div class="login-center">
        <div class="login-center-win">
          ...
          <div class="login-center-opt">
            <div style="font-size: 25px; margin-left: 20px; margin-top: 15px">
              登录
            </div>
            <el-form
              autoComplete="on"
                ...
                <div style="margin-top: 25px">
                  ...
                  <div class="login-input">
                    <img
                      ...
                      style="margin-left: 10px; margin-top: 12px; float: left"
                    />
      ...
      <div
        style="height: 50px; line-height: 50px; width: 100%; text-align: center"
      >
...
.login-center-opt-marg .el-checkbox__label {
  color: #000 !important;
