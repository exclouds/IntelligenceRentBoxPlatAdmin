<template>
  <div class="app-container newbudgetreport" v-loading="bthloading">
                ...
                >   
                  <el-table-column
                   ...
                   <el-table-column
                    ...
                    :label="item.isjust ===true?'调整后实际数':'实际预算数差异'"
                    show-overflow-tooltip
                    ...
                    >        
                     ...
                     <el-table-column
                        ...
                        >        
                           ...
                           <el-table-column
                        align="center"
                        prop="januaryLastYeardifference"
                        label="去年同期实际数差异"
                        show-overflow-tooltip
                        fixed="left"
                        width="130"
                  ...
                  <el-table-column
                   ...
                   <el-table-column
                        ...
                        >        
                           ...
                           <el-table-column
                        align="center"
                        prop="februaryLastYeardifference"
                        label="去年同期实际数差异"
                        show-overflow-tooltip
                        fixed="left"
                        width="130"
                  ...
                  <el-table-column
                   ...
                   <el-table-column
                        ...
                        >        
                           ...
                           <el-table-column
                        align="center"
                        prop="septemberLastYeardifference"
                        label="去年同期实际数差异"
                        show-overflow-tooltip
                        fixed="left"
                        width="130"
                  ...
                  <el-table-column
                   ...
                   <el-table-column
                        ...
                        >        
                           ...
                           <el-table-column
                        align="center"
                        prop="octoberLastYeardifference"
                        label="去年同期实际数差异"
                        show-overflow-tooltip
                        fixed="left"
                        width="130"
                  ...
                  <el-table-column
                   ...
                   <el-table-column
                        ...
                        >        
                           ...
                           <el-table-column
                        align="center"
                        prop="novemberLastYeardifference"
                        label="去年同期实际数差异"
                        show-overflow-tooltip
                        fixed="left"
                        width="130"
                  ...
                  <el-table-column
                   ...
                   <el-table-column
                        ...
                        >        
                           ...
                           <el-table-column
                        align="center"
                        prop="decemberLastYeardifference"
                        label="去年同期实际数差异"
                        show-overflow-tooltip
                        fixed="left"
                        width="130"
...
import { InquireProfitCompareStatement,ExportBudgetFile } from "api/ReportFunction/BudgetReport";
...
export default {
  ...
  methods: {
    ...
    getTableList() {
      ...
      InquireProfitCompareStatement(data)
        .then((res) => {
          if (res.success) {
    ...
    Importdata()
    {
      ...
      ExportBudgetFile(data).then(res=>{
        if(res.success){
           this.bthloading=false;
