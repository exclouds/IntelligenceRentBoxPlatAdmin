<template>
  <div class="app-container zhyreport" v-loading="bthloading">
...
import {
  ZHYInquireStatement,
 } from "api/ReportFunction/ZHYReport";

 import { ExportBUFile,} from "api/ReportFunction/BUReport";
