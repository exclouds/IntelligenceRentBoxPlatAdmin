      ...
      >
       <!-- <el-table-column
            ...
            <template slot-scope="scope" >
              <span>{{ scope.row.data[item1.cloumorder] }}</span>
            </template>
          </el-table-column> -->
           <el-table-column
          type="index"
...
import {GroupAnalyzeInquire ,ExportGroupAnalyzeFile} from "api/ReportFunction/BUAnalyze";
   ...
   setColSpan:function() {
    ...
    getTableList() {
       ...
       this.table.loading = true;
        GroupAnalyzeInquire(data).then(res => {
          if(res.success)
          {
