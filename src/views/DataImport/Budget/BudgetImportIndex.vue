<template>
  <div class="app-container budgetimport"  v-loading="bthloading">
    ...
    <el-row>
        ...
        <el-col :span="12">
          ...
          <el-popover
            ...
            width="400"
            trigger="hover">
                   <el-button type="primary" size="mini" @click="onBatchDelete()" v-if="checkBtnPeimission(budimport.Deletebud.permission)">删除</el-button>
          <el-button type="primary" size="mini" @click="SubmitBudget()" v-if="checkBtnPeimission(budimport.Submitbud.permission)">提交</el-button>
          <el-button type="primary" size="mini" @click="CancelSubmit()"  v-if="checkBtnPeimission(budimport.CancelSubmitbud.permission)">取消提交</el-button>
          <el-button type="primary" size="mini" @click="AgreeCancelSubmit()"  v-if="checkBtnPeimission(budimport.AgreeCancelSubmitbud.permission)">同意取消提交</el-button>
          ...
          <el-popover
            ...
            width="480"
            trigger="hover">
                  <el-button type="primary" size="mini" @click="BathOperation(4)" v-if="checkBtnPeimission(budimport.Deletebud.permission)">批量删除</el-button>
                  <el-button type="primary" size="mini" @click="BathOperation(1)"  v-if="checkBtnPeimission(budimport.Submitbud.permission)">批量提交</el-button>
                  <el-button type="primary" size="mini" @click="BathOperation(2)" v-if="checkBtnPeimission(budimport.CancelSubmitbud.permission)">批量取消提交</el-button>
                  <el-button type="primary" size="mini" @click="BathOperation(3)"  v-if="checkBtnPeimission(budimport.AgreeCancelSubmitbud.permission)">批量同意取消提交</el-button>
...
import {GetBudgetQueryList,DeleteBudget,SubmitBudget,CancelSubmit,AgreeCancelSubmit,BathOperation} from 'api/DataImport/Budget'
