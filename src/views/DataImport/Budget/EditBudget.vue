            ...
            <el-form size="mini" :model="form" ref="ruleForm" :rules="rules" label-width="100px" >
                ...
                <el-row>
                  ...
                  <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="全年合计：" prop="annualTotal">
                             <el-input-number
                              placeholder="全年合计"
                  ...
                  <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="项目名称：" prop="projectName">
                            <el-input size="mini" v-model="form.projectName" placeholder="请输入父级项目名称"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>                 
                <el-row>
...
export default {
    ...
    methods: {
        ...
        getsum(){
            this.form.annualTotal=this.form.january+this.form.february+this.form.march+this.form.april+this.form.may+this.form.june+this.form.july
            +this.form.august+this.form.september+this.form.october+this.form.november+this.form.december;
        },
        //提交
        save() {
