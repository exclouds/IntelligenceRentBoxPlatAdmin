<template>
  <div class="app-container sujectassimport"  v-loading="bthloading">
    ...
    <el-row>
        ...
        <el-button type="primary" size="mini" @click="openAdd()" v-if="checkBtnPeimission(AccountBalanceImport.Createbud.permission)">新增</el-button>
          <!-- <el-popover
            ...
            width="400"
            trigger="hover">
                    <el-button type="primary" size="mini" @click="onBatchDelete()"  v-if="checkBtnPeimission(AccountBalanceImport.Deletebud.permission)">删除</el-button>
          <el-button type="primary" size="mini" @click="SubmitBudget()"  v-if="checkBtnPeimission(AccountBalanceImport.Submitbud.permission)">提交</el-button>
          <el-button type="primary" size="mini" @click="CancelSubmit()"  v-if="checkBtnPeimission(AccountBalanceImport.CancelSubmitbud.permission)">取消提交</el-button>
          <el-button type="primary" size="mini" @click="AgreeCancelSubmit()"  v-if="checkBtnPeimission(AccountBalanceImport.AgreeCancelSubmitbud.permission)">同意取消提交</el-button>
          ...
          <!-- <el-popover
            ...
            width="480"
            trigger="hover"> -->
                  <el-button type="primary" size="mini" @click="BathOperation(4)"  v-if="checkBtnPeimission(AccountBalanceImport.Deletebud.permission)">批量删除</el-button>
                  <el-button type="primary" size="mini" @click="BathOperation(1)"  v-if="checkBtnPeimission(AccountBalanceImport.Submitbud.permission)">批量提交</el-button>
                  <el-button type="primary" size="mini" @click="BathOperation(2)"  v-if="checkBtnPeimission(AccountBalanceImport.CancelSubmitbud.permission)">批量取消提交</el-button>
                  <el-button type="primary" size="mini" @click="BathOperation(3)"  v-if="checkBtnPeimission(AccountBalanceImport.AgreeCancelSubmitbud.permission)">批量同意取消提交</el-button>
...
import{InquireAccountBalance,Dels,SubmitAccountBalance,CancelSubmit,AgreeCancelSubmit,BathOperation} from 'api/DataImport/SubjectAssistance'
