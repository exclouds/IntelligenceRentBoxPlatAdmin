<template>
  <div class="app-container auxibalimport" v-loading="bthloading">
     <el-dialog title="科目余额导入" 
        v-dialogDrag
...
export default {
  ...
  methods: {
        ...
        data[0].parseData.forEach((arrItem,i) => {
          ...
          if(i > 3) {
            ...
            for(let [index,item] of arrItem.entries()) {
             ...
             {   
               obj.subjectCode=obj.subjectCode.toString();
    ...
    setnumber(amttxt){
      if(amttxt==="" || amttxt===null || amttxt===undefined)
      {
        return 0;
      }
