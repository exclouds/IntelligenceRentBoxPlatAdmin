            ...
            <el-form size="mini" :model="form" ref="ruleForm" :rules="rules" label-width="140px" >
             ...
             <el-col :span="12">
                <el-form-item label="所属部门：" prop>               
                    ...
                    disabled clearable filterable collapse-tags 
                        ...
                        <el-col :span="12">
                           ...
                           <el-col :span="12">
                            ...
                            <el-input-number
                                ...
                                clearable
                                style="width: 100%"
                                 :disabled="form.isSubmitCompleted===true"
                                ></el-input-number>   
                            </el-form-item>                      
                        </el-col>
                </el-row>
...
import {GetOrgReportById,CreateOrUpdateOrgReport} from 'api/DataImport/OriginalBudget'
...
export default {
    ...
    //根据公司获取部门
        getdeplist(code,depcode){
            this.form.depCode=depcode;
            this.deptreeComp.data=[];
        ...
        //获取单个特殊费用
        GetOrgReportById(id) {
            GetOrgReportById({id: id}).then(res => {
                this.form = res.result;
                this.getprojectlis(res.result.linNO);
                this.getdeplist(res.result.code,res.result.depCode);
        ...
        save() {
            this.$refs["ruleForm"].validate((valid) => {
                if (valid) {
                    ...
                    CreateOrUpdateOrgReport(data).then(res => {
