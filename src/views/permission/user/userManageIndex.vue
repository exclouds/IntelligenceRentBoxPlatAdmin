  ...
  <div class="app-container userMng">
    ...
    <el-row style="height: calc(100% - 110px)">
      ...
      >
        ...
        <!-- <el-table-column align="center" prop="buAuthority" label="BU权限" show-overflow-tooltip width="120"></el-table-column>
                 <el-table-column align="center" prop="insideBUAuthority" label="内部交易BU权限" show-overflow-tooltip width="120"></el-table-column>
                 <el-table-column align="center" prop="regionAuthority" label="大区权限" show-overflow-tooltip width="120"></el-table-column>
        ...
        <el-table-column align="center" label="操作" width="240px">
          <template slot-scope="scope">
            <div class="tableBtn" @click="openUpdateUserComp(scope.row)">
              编辑
            </div>
            <div
              class="tableBtn"
