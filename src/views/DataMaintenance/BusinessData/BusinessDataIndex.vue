<template>
  <div class="app-container BusinessData"  v-loading="bthloading">
        ...
        <el-col :span="5">
          <el-form-item label prop label-width="10px">
           ...
           <el-popover
            ...
            width="400"
            trigger="hover">
                  <el-button type="primary" size="mini" @click="onBatchDelete()"  v-if="checkBtnPeimission(busdata.delete.permission)">删除</el-button> 
                  <el-button type="primary" size="mini" @click="SubmitBusiness()"  v-if="checkBtnPeimission(busdata.Submitbud.permission)">提交</el-button>
                  <el-button type="primary" size="mini" @click="CancelSubmit()"  v-if="checkBtnPeimission(busdata.CancelSubmitbud.permission)">取消提交</el-button>
                  <el-button type="primary" size="mini" @click="AgreeCancelSubmit()"  v-if="checkBtnPeimission(busdata.AgreeCancelSubmitbud.permission)">同意取消提交</el-button>
          ...
          <el-popover
            ...
            width="480"
            trigger="hover">
                  <el-button type="primary" size="mini" @click="BathOperation(4)"  v-if="checkBtnPeimission(busdata.delete.permission)">批量删除</el-button>
                  <el-button type="primary" size="mini" @click="BathOperation(1)"  v-if="checkBtnPeimission(busdata.Submitbud.permission)">批量提交</el-button>
                  <el-button type="primary" size="mini" @click="BathOperation(2)"  v-if="checkBtnPeimission(busdata.CancelSubmitbud.permission)">批量取消提交</el-button>
                  <el-button type="primary" size="mini" @click="BathOperation(3)"  v-if="checkBtnPeimission(busdata.AgreeCancelSubmitbud.permission)">批量同意取消提交</el-button>
...
import { GetBusinessDataQueryList,BathDeleteBusinessData,SubmitBusiness ,CancelSubmit,AgreeCancelSubmit,BathOperation } from "api/DataMaintenance/BusinessData";
