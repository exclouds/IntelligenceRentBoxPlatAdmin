<template>
  <div class="app-container OtherInsideImportclass" v-loading="bthloading">
...
import{ImportInTransactData} from 'api/DataMaintenance/OtherInsideTransaction'
